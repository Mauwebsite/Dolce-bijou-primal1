        ...
        <div className='flex items-center justify-between py-5 font-medium' >
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`} >
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisble(false)} to="/" className='py-2 pl-6 border'>INICIO</NavLink>
                    <NavLink onClick={() => setVisble(false)} to='/collection' className='py-2 pl-6 border'>CATALOGO</NavLink>
                    {/* <NavLink onClick={() => setVisble(false)} to='/about' className='py-2 pl-6 border'>CONTACTO</NavLink> */}
                    <NavLink onClick={() => setVisble(false)} to='/contact' className='py-2 pl-6 border'>CONTACTO</NavLink>
                </div>
            </div>
        </div>
    )
